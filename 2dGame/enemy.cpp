...
Enemy::Enemy(QOpenGLWidget * _glWidget) {
    glWidget = _glWidget;
...
void Enemy::destroyShaders() {
    glDeleteProgram(shaderProgram);
}

void Enemy::createVBOs() {
    glWidget -> makeCurrent();
    destroyVBOs();
...
void Enemy::drawModel(float size, float x, float y) {
